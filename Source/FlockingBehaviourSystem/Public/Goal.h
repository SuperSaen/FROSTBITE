...
struct FDebugVariables_Goal
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Debug", meta = (ToolTip = "Display all points connected to this goal?"))
		bool bSuppressRandomPointGeneration = false;
};
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Properties", meta = (ToolTip = "The location that the boid will seek towards"))
		FVector GoalLocation;

	UPROPERTY(EditInstanceOnly, Category = "Properties", meta = (ToolTip = "Adjust goal settings"))
		FGoalSettings Settings;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Properties", meta = (ToolTip = "Visualize debug information"))
