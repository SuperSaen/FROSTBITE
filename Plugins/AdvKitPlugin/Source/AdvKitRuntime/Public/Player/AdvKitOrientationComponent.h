...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="AdvKit", DisplayName="Inverse Transform Direction (World To Local)")
	FVector TransformDirectionW2L(const FVector& Direction) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "AdvKit", DisplayName = "Transform Direction (Local To World)")
	FVector TransformDirectionL2W(const FVector& Direction) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "AdvKit", DisplayName = "Inverse Transform Location (World To Local)")
	FVector TransformPositionW2L(const FVector& Position) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "AdvKit", DisplayName = "Transform Location (Local To World)")
	FVector TransformPositionL2W(const FVector& Position) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "AdvKit", DisplayName = "Inverse Transform Rotation (World To Local)")
	FRotator TransformRotationW2L(const FRotator& Rotation) const;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "AdvKit", DisplayName = "Transform Rotation (Local To World)")
	FRotator TransformRotationL2W(const FRotator& Rotation) const;
	 ...
	 * @return	Rotation transformed to local space
	 */
	FQuat TransformRotationW2L(const FQuat& Rotation) const;
	 ...
	 * @return	Rotation transformed to world space
	 */
	FQuat TransformRotationL2W(const FQuat& Rotation) const;
