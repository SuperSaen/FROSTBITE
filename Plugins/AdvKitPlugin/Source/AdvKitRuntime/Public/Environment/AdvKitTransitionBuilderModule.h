...
protected:
	...
	UPROPERTY(BlueprintReadWrite, Category = "Transitions")
...
public:
	...
	AAdvKitZone* GetOuterZone() const;
	...
	//TODO Hotifx for blueprint nativization
	virtual bool CanCreateTransitionsFor_Implementation(UClass* ForCharacterClass, AAdvKitZone* ForZone);
	...
	//TODO Hotifx for blueprint nativization
	virtual void CreateTransitionsFor_Implementation(UClass* ForCharacterClass, AAdvKitZone* ForZone);
	...
	//TODO Hotifx for blueprint nativization
	virtual bool CreateTransitionBetween_Implementation(UClass* ForCharacterClass, AAdvKitZone* SourceZone, AAdvKitZone* TargetZone);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "AdvKit")
	virtual FVector GetCharacterHalfExtent(TSubclassOf<AAdvKitCharacter> ForCharacterClass, AAdvKitZone* ForZone) const;
...
public:
	UFUNCTION(BlueprintCallable, Category = "AdvKit")
	static UAdvKitTransitionComponentPoint* CreateTransitionPoint(
		...
		AAdvKitZone* TargetZone = nullptr, 
		uint8 CustomMovementMode = 0);
	
	UFUNCTION(BlueprintCallable, Category = "AdvKit")
	static UAdvKitTransitionComponentLine* CreateTransitionLine(
		UAdvKitTransitionBuilderModule* ForModule,
		FString Id,
		AAdvKitZone* SourceZone, 
	...
	UFUNCTION(BlueprintCallable, Category = "AdvKit")
	static UAdvKitTransitionComponentSpline* CreateTransitionSpline(
		UAdvKitTransitionBuilderModule* ForModule,
		FString Id,
		AAdvKitZone* SourceZone, 
	...
	UFUNCTION(BlueprintCallable, Category = "AdvKit")
	static UAdvKitTransitionComponentRect* CreateTransitionRect(
		UAdvKitTransitionBuilderModule* ForModule,
		FString Id,
		AAdvKitZone* SourceZone, 
		const FVector& MinWorldSourceLocation, 
...
protected:
	template <typename T>
	static T* CreateTransitionComponent(AAdvKitZone* OnZone, FName TransitionName);

	static FString MakeUniqueId(UAdvKitTransitionBuilderModule* ForModule, FString BaseId, AAdvKitZone* SourceZone, AAdvKitZone* TargetZone);
	static void PostInitTransition(UAdvKitTransitionBuilderModule* ForModule, FString Id, UAdvKitTransitionComponent* Transition, bool bRenameTransition);
};
