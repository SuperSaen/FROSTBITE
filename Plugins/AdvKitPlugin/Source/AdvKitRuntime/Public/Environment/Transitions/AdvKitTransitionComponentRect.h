...
#include "AdvKitTransitionComponentRect.generated.h"

/**
 * @brief Transition that is an area between two defined lines on the source and target zone. 
 */
UCLASS()
class ADVKITRUNTIME_API UAdvKitTransitionComponentRect : public UAdvKitTransitionComponent
{
	GENERATED_BODY()

	friend class FAdvKitTransitionComponentRectVisualizer;
