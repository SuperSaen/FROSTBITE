...
protected:
	...
	/**
	 * Create a jump transition between two ledges that are opposite of each other.
	 * @param	ForCharacterClass 	Character to create transitions for
	 * @param	SourceZone	Start of the transition
	 * @param	TargetZone 	End of the transition
	 * @return True if a transition was created
	 */
	virtual bool CreateBackJumpTransitionBetween(TSubclassOf<AAdvKitCharacter> ForCharacterClass, AAdvKitZone* SourceZone, AAdvKitZone* TargetZone);
