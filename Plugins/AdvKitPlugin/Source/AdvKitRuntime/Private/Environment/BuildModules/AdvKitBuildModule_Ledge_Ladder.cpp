...
bool UAdvKitBuildModule_Ledge_Ladder::CreateTransitionLedgeToLadder(TSubclassOf<AAdvKitCharacter> ForCharacterClass, AAdvKitZone* Ledge, AAdvKitZone* Ladder)
{
	...
	auto Transition = CreateTransitionPoint(this, "JumpToLadder", Ledge, StartLocation, EndLocation, ForCharacterClass, Ladder->GetPhysics(), Ladder);
	if (!Transition)
	{
		return false;
	}
...
bool UAdvKitBuildModule_Ledge_Ladder::CreateTransitionLadderToLedge(TSubclassOf<AAdvKitCharacter> ForCharacterClass, AAdvKitZone* Ladder, AAdvKitZone* Ledge)
{
	...
	auto Transition = CreateTransitionPoint(this, "JumpToLedge", Ladder, SourceLocation, TargetLocation, ForCharacterClass, Ledge->GetPhysics(), Ledge);
	if (!Transition)
	{
		return false;
	}
