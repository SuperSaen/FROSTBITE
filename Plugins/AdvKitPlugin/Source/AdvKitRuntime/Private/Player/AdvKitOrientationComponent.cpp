...
FVector UAdvKitOrientationComponent::TransformDirectionW2L(const FVector& Direction) const
{
	return GetComponentQuat().Inverse().RotateVector(Direction);
}

FVector UAdvKitOrientationComponent::TransformDirectionL2W(const FVector& Direction) const
{
	return GetComponentQuat().RotateVector(Direction);
}

FVector UAdvKitOrientationComponent::TransformPositionW2L(const FVector& Position) const
{
	return GetComponentTransform().InverseTransformPositionNoScale(Position);

}

FVector UAdvKitOrientationComponent::TransformPositionL2W(const FVector& Position) const
{
	return GetComponentTransform().TransformPositionNoScale(Position);
}

FRotator UAdvKitOrientationComponent::TransformRotationW2L(const FRotator& Rotation) const
{
	return TransformRotationW2L(Rotation.Quaternion()).Rotator();
	//return Rotation - GetComponentRotation();
}

FRotator UAdvKitOrientationComponent::TransformRotationL2W(const FRotator& Rotation) const
{
	return TransformRotationL2W(Rotation.Quaternion()).Rotator();
	//return Rotation + GetComponentRotation();
}

FQuat UAdvKitOrientationComponent::TransformRotationW2L(const FQuat&  Rotation) const
{
	return GetComponentQuat().Inverse()*Rotation;
}

FQuat UAdvKitOrientationComponent::TransformRotationL2W(const FQuat&  Rotation) const
{
