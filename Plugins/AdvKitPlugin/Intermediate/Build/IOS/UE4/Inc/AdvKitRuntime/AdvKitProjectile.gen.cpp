...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAdvKitProjectile_Init_Statics::NewProp_Direction = { UE4CodeGen_Private::EPropertyClass::Struct, "Direction", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000008000182, 1, nullptr, STRUCT_OFFSET(AdvKitProjectile_eventInit_Parms, Direction), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitProjectile_Init_Statics::NewProp_Direction_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitProjectile_Init_Statics::NewProp_Direction_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitProjectile_Init_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitProjectile, "Init", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04C20400, sizeof(AdvKitProjectile_eventInit_Parms), Z_Construct_UFunction_AAdvKitProjectile_Init_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitProjectile_Init_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitProjectile_Init_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitProjectile_Init_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitProjectile_OnImpact_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitProjectile, "OnImpact", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x08420C00, sizeof(AdvKitProjectile_eventOnImpact_Parms), Z_Construct_UFunction_AAdvKitProjectile_OnImpact_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitProjectile_OnImpact_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitProjectile_OnImpact_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitProjectile_OnImpact_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AAdvKitProjectile_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AAdvKitProjectile_Init, "Init" }, // 319887139
		{ &Z_Construct_UFunction_AAdvKitProjectile_OnImpact, "OnImpact" }, // 3826787965
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AAdvKitProjectile_Statics::NewProp_DefaultRootComponent = { UE4CodeGen_Private::EPropertyClass::Object, "DefaultRootComponent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00200800000a001d, 1, nullptr, STRUCT_OFFSET(AAdvKitProjectile, DefaultRootComponent), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AAdvKitProjectile_Statics::NewProp_DefaultRootComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitProjectile_Statics::NewProp_DefaultRootComponent_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AAdvKitProjectile_Statics::ClassParams = {
		...
		Z_Construct_UClass_AAdvKitProjectile_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AAdvKitProjectile_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(AAdvKitProjectile, 1411538140);
