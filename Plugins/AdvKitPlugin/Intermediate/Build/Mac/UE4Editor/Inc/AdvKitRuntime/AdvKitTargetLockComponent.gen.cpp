...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::NewProp_TargetOffset = { UE4CodeGen_Private::EPropertyClass::Struct, "TargetOffset", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UAdvKitTargetLockComponent, TargetOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::NewProp_TargetOffset_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::NewProp_TargetOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::NewProp_MinimumDistanceFromCenter = { UE4CodeGen_Private::EPropertyClass::Float, "MinimumDistanceFromCenter", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UAdvKitTargetLockComponent, MinimumDistanceFromCenter), METADATA_PARAMS(Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::NewProp_MinimumDistanceFromCenter_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::NewProp_MinimumDistanceFromCenter_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::ClassParams = {
		...
		0x00B000A0u,
		nullptr, 0,
		Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::PropPointers),
		nullptr,
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTargetLockComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAdvKitTargetLockComponent, 1961608111);
