...
// End Cross Module References
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AAdvKitTargetPoint_GetTargetedActor_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Object, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(AdvKitTargetPoint_eventGetTargetedActor_Parms, ReturnValue), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitTargetPoint_GetTargetedActor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitTargetPoint, "GetTargetedActor", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(AdvKitTargetPoint_eventGetTargetedActor_Parms), Z_Construct_UFunction_AAdvKitTargetPoint_GetTargetedActor_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitTargetPoint_GetTargetedActor_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitTargetPoint_GetTargetedActor_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitTargetPoint_GetTargetedActor_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AAdvKitTargetPoint_IsValidTarget_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Bool, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(AdvKitTargetPoint_eventIsValidTarget_Parms), &Z_Construct_UFunction_AAdvKitTargetPoint_IsValidTarget_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitTargetPoint_IsValidTarget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitTargetPoint, "IsValidTarget", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(AdvKitTargetPoint_eventIsValidTarget_Parms), Z_Construct_UFunction_AAdvKitTargetPoint_IsValidTarget_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitTargetPoint_IsValidTarget_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitTargetPoint_IsValidTarget_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitTargetPoint_IsValidTarget_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AAdvKitTargetPoint_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AAdvKitTargetPoint_GetTargetedActor, "GetTargetedActor" }, // 1685669563
		{ &Z_Construct_UFunction_AAdvKitTargetPoint_IsValidTarget, "IsValidTarget" }, // 3340073924
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAdvKitTargetPoint_Statics::NewProp_bCanBeTargeted = { UE4CodeGen_Private::EPropertyClass::Bool, "bCanBeTargeted", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(AAdvKitTargetPoint), &Z_Construct_UClass_AAdvKitTargetPoint_Statics::NewProp_bCanBeTargeted_SetBit, METADATA_PARAMS(Z_Construct_UClass_AAdvKitTargetPoint_Statics::NewProp_bCanBeTargeted_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitTargetPoint_Statics::NewProp_bCanBeTargeted_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AAdvKitTargetPoint_Statics::ClassParams = {
		...
		Z_Construct_UClass_AAdvKitTargetPoint_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AAdvKitTargetPoint_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(AAdvKitTargetPoint, 2994811163);
