...
// End Cross Module References
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Struct, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000580, 1, nullptr, STRUCT_OFFSET(AdvKitZoneRectangle_eventGetProjectedHalfExtent_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::NewProp_ExtentWorldRotation = { UE4CodeGen_Private::EPropertyClass::Struct, "ExtentWorldRotation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000008000182, 1, nullptr, STRUCT_OFFSET(AdvKitZoneRectangle_eventGetProjectedHalfExtent_Parms, ExtentWorldRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::NewProp_ExtentWorldRotation_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::NewProp_ExtentWorldRotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::NewProp_HalfExtent = { UE4CodeGen_Private::EPropertyClass::Struct, "HalfExtent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000008000182, 1, nullptr, STRUCT_OFFSET(AdvKitZoneRectangle_eventGetProjectedHalfExtent_Parms, HalfExtent), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::NewProp_HalfExtent_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::NewProp_HalfExtent_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitZoneRectangle, "GetProjectedHalfExtent", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x54C80400, sizeof(AdvKitZoneRectangle_eventGetProjectedHalfExtent_Parms), Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AAdvKitZoneRectangle_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AAdvKitZoneRectangle_GetProjectedHalfExtent, "GetProjectedHalfExtent" }, // 3805682499
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAdvKitZoneRectangle_Statics::NewProp_LocalRectMaxBoundary = { UE4CodeGen_Private::EPropertyClass::Struct, "LocalRectMaxBoundary", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(AAdvKitZoneRectangle, LocalRectMaxBoundary), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AAdvKitZoneRectangle_Statics::NewProp_LocalRectMaxBoundary_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneRectangle_Statics::NewProp_LocalRectMaxBoundary_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAdvKitZoneRectangle_Statics::NewProp_LocalRectMinBoundary = { UE4CodeGen_Private::EPropertyClass::Struct, "LocalRectMinBoundary", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(AAdvKitZoneRectangle, LocalRectMinBoundary), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AAdvKitZoneRectangle_Statics::NewProp_LocalRectMinBoundary_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneRectangle_Statics::NewProp_LocalRectMinBoundary_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AAdvKitZoneRectangle_Statics::ClassParams = {
		...
		Z_Construct_UClass_AAdvKitZoneRectangle_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneRectangle_Statics::PropPointers),
		nullptr,
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_AAdvKitZoneRectangle_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneRectangle_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AAdvKitZoneRectangle, 3952117726);
