...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::NewProp_bCreateEndTransition = { UE4CodeGen_Private::EPropertyClass::Bool, "bCreateEndTransition", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000015, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UAdvKitBuildModule_Tightspace), &Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::NewProp_bCreateEndTransition_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::NewProp_bCreateEndTransition_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::NewProp_bCreateEndTransition_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::NewProp_bCreateStartTransition = { UE4CodeGen_Private::EPropertyClass::Bool, "bCreateStartTransition", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0020080000000015, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UAdvKitBuildModule_Tightspace), &Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::NewProp_bCreateStartTransition_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::NewProp_bCreateStartTransition_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::NewProp_bCreateStartTransition_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::ClassParams = {
		...
		0x009030A0u,
		nullptr, 0,
		Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::PropPointers),
		nullptr,
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAdvKitBuildModule_Tightspace_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAdvKitBuildModule_Tightspace, 2891512229);
