...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeSpeed = { UE4CodeGen_Private::EPropertyClass::Float, "DodgeSpeed", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UAnimNotifyState_AdvKitDodge, DodgeSpeed), METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeSpeed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeAlpha = { UE4CodeGen_Private::EPropertyClass::Float, "DodgeAlpha", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000014, 1, nullptr, STRUCT_OFFSET(UAnimNotifyState_AdvKitDodge, DodgeAlpha), METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeAlpha_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeAlpha_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeDuration = { UE4CodeGen_Private::EPropertyClass::Float, "DodgeDuration", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000014, 1, nullptr, STRUCT_OFFSET(UAnimNotifyState_AdvKitDodge, DodgeDuration), METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeDuration_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeDuration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeDirection = { UE4CodeGen_Private::EPropertyClass::Struct, "DodgeDirection", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000014, 1, nullptr, STRUCT_OFFSET(UAnimNotifyState_AdvKitDodge, DodgeDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeDirection_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeDirection_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeSpeedCurve = { UE4CodeGen_Private::EPropertyClass::Struct, "DodgeSpeedCurve", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, STRUCT_OFFSET(UAnimNotifyState_AdvKitDodge, DodgeSpeedCurve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeSpeedCurve_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::NewProp_DodgeSpeedCurve_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::ClassParams = {
		...
		0x000130A0u,
		nullptr, 0,
		Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::PropPointers),
		nullptr,
		&StaticCppClassTypeInfo,
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_AdvKitDodge_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAnimNotifyState_AdvKitDodge, 127951628);
