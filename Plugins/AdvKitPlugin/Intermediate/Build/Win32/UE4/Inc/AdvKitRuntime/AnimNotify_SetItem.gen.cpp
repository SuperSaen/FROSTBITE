...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_NewItem_MetaData[] = {
		...
		{ "Comment", "/** Item to change to */" },
		{ "EditCondition", "bSetLocation" },
		{ "ModuleRelativePath", "Public/Actions/AnimNotify_SetItem.h" },
		{ "ToolTip", "Item to change to" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_NewItem = { "NewItem", nullptr, (EPropertyFlags)0x0024080000000015, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimNotify_SetItem, NewItem), Z_Construct_UClass_AAdvKitInventoryItem_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_NewItem_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_NewItem_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_bInstant_MetaData[] = {
		{ "Category", "Configuration" },
		{ "Comment", "/** Change to the new item instantly */" },
		{ "ModuleRelativePath", "Public/Actions/AnimNotify_SetItem.h" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_bInstant = { "bInstant", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAnimNotify_SetItem), &Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_bInstant_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_bInstant_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_SetItem_Statics::NewProp_bInstant_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimNotify_SetItem_Statics::ClassParams = {
		...
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_UAnimNotify_SetItem_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_SetItem_Statics::PropPointers),
		0,
		0x000120A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_SetItem_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_SetItem_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAnimNotify_SetItem, 1351494127);
	template<> ADVKITRUNTIME_API UClass* StaticClass<UAnimNotify_SetItem>()
	{
		return UAnimNotify_SetItem::StaticClass();
	}
