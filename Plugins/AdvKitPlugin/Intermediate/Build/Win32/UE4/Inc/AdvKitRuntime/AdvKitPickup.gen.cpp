...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AAdvKitPickup_CanBePickedUpBy_Statics::Function_MetaDataParams[] = {
		{ "Category", "AdvKit" },
		{ "Comment", "/**\n\x09 * Can a character pick this pickup up? (what a question indeed...)\n\x09 * \n\x09 * @param\x09""Character\x09The character that wants to pick up this object.\n\x09 * @return\x09\x09\x09\x09True if character can pick up the object.\n\x09 */" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitPickup_CanBePickedUpBy_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitPickup, nullptr, "CanBePickedUpBy", nullptr, nullptr, sizeof(AdvKitPickup_eventCanBePickedUpBy_Parms), Z_Construct_UFunction_AAdvKitPickup_CanBePickedUpBy_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AAdvKitPickup_CanBePickedUpBy_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitPickup_CanBePickedUpBy_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AAdvKitPickup_CanBePickedUpBy_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AAdvKitPickup_PickedUpBy_Statics::Function_MetaDataParams[] = {
		{ "BlueprintProtected", "" },
		{ "Category", "AdvKit" },
		{ "Comment", "/**\n\x09 * Picked up by a character (should only be called when CanBePickedUpBy returns true)\n\x09 *\n\x09 * @param\x09""Character\x09The character that picked up this object.\n\x09 */" },
		{ "ModuleRelativePath", "Public/Items/AdvKitPickup.h" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitPickup_PickedUpBy_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitPickup, nullptr, "PickedUpBy", nullptr, nullptr, sizeof(AdvKitPickup_eventPickedUpBy_Parms), Z_Construct_UFunction_AAdvKitPickup_PickedUpBy_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AAdvKitPickup_PickedUpBy_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08080C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitPickup_PickedUpBy_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AAdvKitPickup_PickedUpBy_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AAdvKitPickup_Respawn_Statics::Function_MetaDataParams[] = {
		{ "Category", "AdvKit" },
		{ "Comment", "/**\n\x09 * Called by a timer after RespawnTime\n\x09 */" },
		{ "ModuleRelativePath", "Public/Items/AdvKitPickup.h" },
		{ "ToolTip", "Called by a timer after RespawnTime" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitPickup_Respawn_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitPickup, nullptr, "Respawn", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitPickup_Respawn_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AAdvKitPickup_Respawn_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AAdvKitPickup_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AAdvKitPickup_CanBePickedUpBy, "CanBePickedUpBy" }, // 2196064205
		{ &Z_Construct_UFunction_AAdvKitPickup_PickedUpBy, "PickedUpBy" }, // 904653719
		{ &Z_Construct_UFunction_AAdvKitPickup_Respawn, "Respawn" }, // 1955887064
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bCanBePickedUpByOverlap_MetaData[] = {
		{ "Category", "Pickup" },
		{ "Comment", "/** Can this be picked up by the character overlapping it? */" },
		{ "ModuleRelativePath", "Public/Items/AdvKitPickup.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bCanBePickedUpWithUse_MetaData[] = {
		{ "Category", "Pickup" },
		{ "Comment", "/** Can this be picked up with the UsedBy function? */" },
		{ "ModuleRelativePath", "Public/Items/AdvKitPickup.h" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bCanBePickedUpWithUse = { "bCanBePickedUpWithUse", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AAdvKitPickup), &Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bCanBePickedUpWithUse_SetBit, METADATA_PARAMS(Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bCanBePickedUpWithUse_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bCanBePickedUpWithUse_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bActive_MetaData[] = {
		{ "Category", "Pickup" },
		{ "Comment", "/** Whether this pickup is currently active (and visible etc...). */" },
		{ "ModuleRelativePath", "Public/Items/AdvKitPickup.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bRespawnAfterPickup_MetaData[] = {
		{ "Category", "Pickup" },
		{ "Comment", "/** Respawn after being picked up. */" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bRespawnAfterPickup = { "bRespawnAfterPickup", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AAdvKitPickup), &Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bRespawnAfterPickup_SetBit, METADATA_PARAMS(Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bRespawnAfterPickup_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bRespawnAfterPickup_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAdvKitPickup_Statics::NewProp_bDestroyOnPickup_MetaData[] = {
		{ "Category", "Pickup" },
		{ "Comment", "/** Destroy this pickup actor after being picked up by a character. */" },
		{ "ModuleRelativePath", "Public/Items/AdvKitPickup.h" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AAdvKitPickup_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UClass_AAdvKitPickup_Statics::PropPointers),
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AAdvKitPickup_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AAdvKitPickup_Statics::Class_MetaDataParams))
	};
