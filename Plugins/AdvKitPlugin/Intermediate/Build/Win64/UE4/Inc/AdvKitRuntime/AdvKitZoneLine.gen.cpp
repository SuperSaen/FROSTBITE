...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent_Statics::NewProp_LocalDirection = { "LocalDirection", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AdvKitZoneLine_eventGetProjectedHalfExtent_Parms, LocalDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent_Statics::NewProp_LocalDirection_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent_Statics::NewProp_LocalDirection_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitZoneLine, nullptr, "GetProjectedHalfExtent", sizeof(AdvKitZoneLine_eventGetProjectedHalfExtent_Parms), Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54C80400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AAdvKitZoneLine_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AAdvKitZoneLine_GetProjectedHalfExtent, "GetProjectedHalfExtent" }, // 3994013668
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAdvKitZoneLine_Statics::NewProp_ZoneEnd = { "ZoneEnd", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAdvKitZoneLine, ZoneEnd), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AAdvKitZoneLine_Statics::NewProp_ZoneEnd_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneLine_Statics::NewProp_ZoneEnd_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAdvKitZoneLine_Statics::NewProp_ZoneStart = { "ZoneStart", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAdvKitZoneLine, ZoneStart), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AAdvKitZoneLine_Statics::NewProp_ZoneStart_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneLine_Statics::NewProp_ZoneStart_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AAdvKitZoneLine_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneLine_Statics::PropPointers),
		0,
		0x009000A1u,
	...
	IMPLEMENT_CLASS(AAdvKitZoneLine, 2304269345);
