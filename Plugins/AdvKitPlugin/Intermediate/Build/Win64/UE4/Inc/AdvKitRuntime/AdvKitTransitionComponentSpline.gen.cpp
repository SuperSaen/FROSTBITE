...
static struct FScriptStruct_AdvKitRuntime_StaticRegisterNativesFSplineTransitionPosition
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSplineTransitionPosition_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FSplineTransitionPosition_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FSplineTransitionPosition_Hash() { return 1298276337U; }
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitTransitionComponentSpline_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAdvKitTransitionComponentSpline_Statics::PropPointers),
		0,
		0x00B000A4u,
	...
	IMPLEMENT_CLASS(UAdvKitTransitionComponentSpline, 4160004164);
