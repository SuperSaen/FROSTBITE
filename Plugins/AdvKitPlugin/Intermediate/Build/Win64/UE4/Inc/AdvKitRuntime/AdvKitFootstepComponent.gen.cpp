...
static struct FScriptStruct_AdvKitRuntime_StaticRegisterNativesFFootStepSound
{
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFootStepSound_Statics::ReturnStructParams = {
		...
		ARRAY_COUNT(Z_Construct_UScriptStruct_FFootStepSound_Statics::PropPointers),
	...
	uint32 Get_Z_Construct_UScriptStruct_FFootStepSound_Hash() { return 4153483675U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAdvKitFootstepComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAdvKitFootstepComponent_PlayFootstep, "PlayFootstep" }, // 2899502648
		{ &Z_Construct_UFunction_UAdvKitFootstepComponent_PlayFootstepAttached, "PlayFootstepAttached" }, // 3415984668
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootStepTraceDistance = { "FootStepTraceDistance", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitFootstepComponent, FootStepTraceDistance), METADATA_PARAMS(Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootStepTraceDistance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootStepTraceDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootSocketNames = { "FootSocketNames", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitFootstepComponent, FootSocketNames), METADATA_PARAMS(Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootSocketNames_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootSocketNames_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootStepSounds = { "FootStepSounds", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitFootstepComponent, FootStepSounds), METADATA_PARAMS(Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootStepSounds_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitFootstepComponent_Statics::NewProp_FootStepSounds_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitFootstepComponent_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UAdvKitFootstepComponent_Statics::PropPointers),
		0,
		0x00B000A4u,
	...
	IMPLEMENT_CLASS(UAdvKitFootstepComponent, 1237667652);
