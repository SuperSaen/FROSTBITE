...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAnimNotify_ApplyTransitionMovementMode_Statics::NewProp_FallbackCustomMovementMode = { "FallbackCustomMovementMode", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimNotify_ApplyTransitionMovementMode, FallbackCustomMovementMode), nullptr, METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_ApplyTransitionMovementMode_Statics::NewProp_FallbackCustomMovementMode_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_ApplyTransitionMovementMode_Statics::NewProp_FallbackCustomMovementMode_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimNotify_ApplyTransitionMovementMode_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_ApplyTransitionMovementMode_Statics::PropPointers),
		0,
		0x000120A0u,
	...
	IMPLEMENT_CLASS(UAnimNotify_ApplyTransitionMovementMode, 1497903557);
