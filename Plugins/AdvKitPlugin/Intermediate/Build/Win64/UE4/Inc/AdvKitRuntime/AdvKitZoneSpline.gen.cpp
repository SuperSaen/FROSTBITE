...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::NewProp_HalfExtent = { "HalfExtent", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AdvKitZoneSpline_eventGetProjectedHalfExtent_Parms, HalfExtent), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::NewProp_HalfExtent_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::NewProp_HalfExtent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::NewProp_LocalDirection = { "LocalDirection", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AdvKitZoneSpline_eventGetProjectedHalfExtent_Parms, LocalDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::NewProp_LocalDirection_MetaData, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::NewProp_LocalDirection_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AAdvKitZoneSpline, nullptr, "GetProjectedHalfExtent", sizeof(AdvKitZoneSpline_eventGetProjectedHalfExtent_Parms), Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54C80400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AAdvKitZoneSpline_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AAdvKitZoneSpline_GetProjectedHalfExtent, "GetProjectedHalfExtent" }, // 3053733752
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AAdvKitZoneSpline_Statics::NewProp_bConstrainExtentAtEnd = { "bConstrainExtentAtEnd", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AAdvKitZoneSpline), &Z_Construct_UClass_AAdvKitZoneSpline_Statics::NewProp_bConstrainExtentAtEnd_SetBit, METADATA_PARAMS(Z_Construct_UClass_AAdvKitZoneSpline_Statics::NewProp_bConstrainExtentAtEnd_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneSpline_Statics::NewProp_bConstrainExtentAtEnd_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AAdvKitZoneSpline_Statics::NewProp_SplineComponent = { "SplineComponent", nullptr, (EPropertyFlags)0x00200800000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAdvKitZoneSpline, SplineComponent), Z_Construct_UClass_USplineComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AAdvKitZoneSpline_Statics::NewProp_SplineComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneSpline_Statics::NewProp_SplineComponent_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AAdvKitZoneSpline_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_AAdvKitZoneSpline_Statics::PropPointers),
		0,
		0x009000A1u,
	...
	IMPLEMENT_CLASS(AAdvKitZoneSpline, 2678998502);
