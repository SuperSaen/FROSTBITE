...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AAdvKitAmmunitionPickup_Statics::NewProp_Ammunition = { "Ammunition", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAdvKitAmmunitionPickup, Ammunition), METADATA_PARAMS(Z_Construct_UClass_AAdvKitAmmunitionPickup_Statics::NewProp_Ammunition_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitAmmunitionPickup_Statics::NewProp_Ammunition_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AAdvKitAmmunitionPickup_Statics::NewProp_AmmuntionForWeapon = { "AmmuntionForWeapon", nullptr, (EPropertyFlags)0x0024080000000015, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAdvKitAmmunitionPickup, AmmuntionForWeapon), Z_Construct_UClass_AAdvKitWeapon_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AAdvKitAmmunitionPickup_Statics::NewProp_AmmuntionForWeapon_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAdvKitAmmunitionPickup_Statics::NewProp_AmmuntionForWeapon_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AAdvKitAmmunitionPickup_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AAdvKitAmmunitionPickup_Statics::PropPointers),
		0,
		0x009000A0u,
	...
	IMPLEMENT_CLASS(AAdvKitAmmunitionPickup, 3451840275);
