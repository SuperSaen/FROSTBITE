...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAdvKitBuildModule_Ledge_Statics::NewProp_FloorTraceDistance = { "FloorTraceDistance", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitBuildModule_Ledge, FloorTraceDistance), METADATA_PARAMS(Z_Construct_UClass_UAdvKitBuildModule_Ledge_Statics::NewProp_FloorTraceDistance_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitBuildModule_Ledge_Statics::NewProp_FloorTraceDistance_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitBuildModule_Ledge_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAdvKitBuildModule_Ledge_Statics::PropPointers),
		0,
		0x009030A0u,
	...
	IMPLEMENT_CLASS(UAdvKitBuildModule_Ledge, 2819699788);
