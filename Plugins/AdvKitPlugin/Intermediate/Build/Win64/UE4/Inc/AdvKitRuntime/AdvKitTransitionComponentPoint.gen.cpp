...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAdvKitTransitionComponentPoint_Statics::NewProp_SourcePosition = { "SourcePosition", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitTransitionComponentPoint, SourcePosition), Z_Construct_UScriptStruct_FBasedPosition, METADATA_PARAMS(Z_Construct_UClass_UAdvKitTransitionComponentPoint_Statics::NewProp_SourcePosition_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTransitionComponentPoint_Statics::NewProp_SourcePosition_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAdvKitTransitionComponentPoint_Statics::NewProp_TargetPosition = { "TargetPosition", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitTransitionComponentPoint, TargetPosition), Z_Construct_UScriptStruct_FBasedPosition, METADATA_PARAMS(Z_Construct_UClass_UAdvKitTransitionComponentPoint_Statics::NewProp_TargetPosition_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTransitionComponentPoint_Statics::NewProp_TargetPosition_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitTransitionComponentPoint_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UAdvKitTransitionComponentPoint_Statics::PropPointers),
		0,
		0x00B000A4u,
	...
	IMPLEMENT_CLASS(UAdvKitTransitionComponentPoint, 3662350881);
