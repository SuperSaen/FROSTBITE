...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition_Statics::NewProp_InDirection = { "InDirection", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AdvKitTransitionComponent_eventCanTransition_Parms, InDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition_Statics::NewProp_InDirection_MetaData, ARRAY_COUNT(Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition_Statics::NewProp_InDirection_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAdvKitTransitionComponent, nullptr, "CanTransition", sizeof(AdvKitTransitionComponent_eventCanTransition_Parms), Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C20400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvKitTransitionComponent_IsDynamicTransitionValid_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAdvKitTransitionComponent, nullptr, "IsDynamicTransitionValid", sizeof(AdvKitTransitionComponent_eventIsDynamicTransitionValid_Parms), Z_Construct_UFunction_UAdvKitTransitionComponent_IsDynamicTransitionValid_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UAdvKitTransitionComponent_IsDynamicTransitionValid_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAdvKitTransitionComponent_IsDynamicTransitionValid_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UAdvKitTransitionComponent_IsDynamicTransitionValid_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAdvKitTransitionComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAdvKitTransitionComponent_CanTransition, "CanTransition" }, // 2144866297
		{ &Z_Construct_UFunction_UAdvKitTransitionComponent_GetClosestSourcePosition, "GetClosestSourcePosition" }, // 3481086086
		{ &Z_Construct_UFunction_UAdvKitTransitionComponent_GetClosestTargetPosition, "GetClosestTargetPosition" }, // 1975989738
		{ &Z_Construct_UFunction_UAdvKitTransitionComponent_IsDynamicTransitionValid, "IsDynamicTransitionValid" }, // 413185038
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_TargetCustomPhysics = { "TargetCustomPhysics", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitTransitionComponent, TargetCustomPhysics), nullptr, METADATA_PARAMS(Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_TargetCustomPhysics_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_TargetCustomPhysics_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_MinLocationRadius = { "MinLocationRadius", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitTransitionComponent, MinLocationRadius), METADATA_PARAMS(Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_MinLocationRadius_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_MinLocationRadius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_TransitionDirection = { "TransitionDirection", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAdvKitTransitionComponent, TransitionDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_TransitionDirection_MetaData, ARRAY_COUNT(Z_Construct_UClass_UAdvKitTransitionComponent_Statics::NewProp_TransitionDirection_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitTransitionComponent_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_UAdvKitTransitionComponent_Statics::PropPointers),
		0,
		0x00B000A5u,
	...
	IMPLEMENT_CLASS(UAdvKitTransitionComponent, 568767072);
