...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitBuildModule_Balance_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UAdvKitBuildModule_Balance_Statics::PropPointers),
		0,
		0x009030A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAdvKitBuildModule_Balance_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAdvKitBuildModule_Balance_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAdvKitBuildModule_Balance, 2886955945);
