...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::NewProp_bSetRotation_MetaData[] = {
		{ "Category", "Configuration" },
		{ "Comment", "/** Whether to set a relative rotation */" },
		{ "ModuleRelativePath", "Public/Actions/AnimNotify_OrientToZone.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::NewProp_Location_MetaData[] = {
		{ "Category", "Configuration" },
		{ "Comment", "/** Relative location to set */" },
		{ "EditCondition", "bSetLocation" },
		{ "ModuleRelativePath", "Public/Actions/AnimNotify_OrientToZone.h" },
		{ "ToolTip", "Relative location to set" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimNotify_OrientToZone, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::NewProp_bSetLocation_MetaData[] = {
		{ "Category", "Configuration" },
		{ "Comment", "/** Whether to set a relative location */" },
		{ "ModuleRelativePath", "Public/Actions/AnimNotify_OrientToZone.h" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::PropPointers),
		0,
		0x000120A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_OrientToZone_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAnimNotify_OrientToZone, 3494132495);
