...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimNotify_SetTransitionZone_Statics::NewProp_bSnapToZone = { "bSnapToZone", nullptr, (EPropertyFlags)0x0020080000000011, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAnimNotify_SetTransitionZone), &Z_Construct_UClass_UAnimNotify_SetTransitionZone_Statics::NewProp_bSnapToZone_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_SetTransitionZone_Statics::NewProp_bSnapToZone_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_SetTransitionZone_Statics::NewProp_bSnapToZone_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimNotify_SetTransitionZone_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_SetTransitionZone_Statics::PropPointers),
		0,
		0x000120A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_SetTransitionZone_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_SetTransitionZone_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UAnimNotify_SetTransitionZone, 4201046468);
