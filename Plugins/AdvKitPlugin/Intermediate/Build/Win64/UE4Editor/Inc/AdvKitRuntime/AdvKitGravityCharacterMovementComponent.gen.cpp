...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_OnOrientationChanged_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent, nullptr, "OnOrientationChanged", nullptr, nullptr, sizeof(AdvKitGravityCharacterMovementComponent_eventOnOrientationChanged_Parms), Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_OnOrientationChanged_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_OnOrientationChanged_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00C20400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_OnOrientationChanged_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_OnOrientationChanged_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_SetGravityVector_Statics::Function_MetaDataParams[] = {
		{ "Category", "Gravity" },
		{ "Comment", "/**\n\x09 * Checks if a hit result is a valid floor for wall walking\n\x09 * @param\x09GravityDirection \x09New direction of gravity\n\x09 * @param\x09GravityOrigin\x09\x09New origin of gravity\n\x09 * @param\x09""bForce\x09\x09\x09\x09Set new gravity immediately, false to interpolate slowly\n\x09 */" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_SetGravityVector_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent, nullptr, "SetGravityVector", nullptr, nullptr, sizeof(AdvKitGravityCharacterMovementComponent_eventSetGravityVector_Parms), Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_SetGravityVector_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_SetGravityVector_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C20400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_SetGravityVector_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_SetGravityVector_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_OnOrientationChanged, "OnOrientationChanged" }, // 2648455159
		{ &Z_Construct_UFunction_UAdvKitGravityCharacterMovementComponent_SetGravityVector, "SetGravityVector" }, // 2374300209
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent_Statics::NewProp_bResetOrientationWhenFalling_MetaData[] = {
		{ "Category", "Gravity" },
		{ "Comment", "/** Reset gravity orientation when the character is falling (useful for things like magnetic boots) */" },
		{ "ModuleRelativePath", "Public/Player/AdvKitGravityCharacterMovementComponent.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent_Statics::NewProp_bUpdateWorldOrientationByFloorResult_MetaData[] = {
		{ "Category", "Gravity" },
		{ "Comment", "/** Update the gravity orientation with the floor the character is walking on */" },
		{ "ModuleRelativePath", "Public/Player/AdvKitGravityCharacterMovementComponent.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent_Statics::NewProp_bUpdateWorldOrientationByTracing_MetaData[] = {
		{ "Category", "Gravity" },
		{ "Comment", "/** Update the gravity orientation with the floor that is hit by the character's tracing component */" },
		{ "ModuleRelativePath", "Public/Player/AdvKitGravityCharacterMovementComponent.h" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent_Statics::PropPointers),
		0,
		0x00B002A4u,
		METADATA_PARAMS(Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAdvKitGravityCharacterMovementComponent_Statics::Class_MetaDataParams))
	};
