...
{
	return UKismetSystemLibrary::LineTraceSingle(this, GetStart(), GetEnd(), TraceChannel, bTraceComplex, ActorsToIgnore, DrawDebugType, OutHit, bIgnoreSelf);
}
...
{
	return UKismetSystemLibrary::LineTraceMulti(this, GetStart(), GetEnd(), TraceChannel, bTraceComplex, ActorsToIgnore, DrawDebugType, OutHits, bIgnoreSelf);
}
...
{
	return UKismetSystemLibrary::SphereTraceSingle(this, GetStart(), GetEnd(), Radius, TraceChannel, bTraceComplex, ActorsToIgnore, DrawDebugType, OutHit, bIgnoreSelf);
}
...
{
	return UKismetSystemLibrary::SphereTraceMulti(this, GetStart(), GetEnd(), Radius, TraceChannel, bTraceComplex, ActorsToIgnore, DrawDebugType, OutHits, bIgnoreSelf);
}
...
{
	return UKismetSystemLibrary::CapsuleTraceSingle(this, GetStart(), GetEnd(), Radius, HalfHeight, TraceChannel, bTraceComplex, ActorsToIgnore, DrawDebugType, OutHit, bIgnoreSelf);
}
...
{
	return UKismetSystemLibrary::CapsuleTraceMulti(this, GetStart(), GetEnd(), Radius, HalfHeight, TraceChannel, bTraceComplex, ActorsToIgnore, DrawDebugType, OutHits, bIgnoreSelf);
}
