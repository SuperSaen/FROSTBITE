...
bool UAdvKitBuildModule_Wall_Ceiling::CreateTransitionFromWallToCeiling(TSubclassOf<AAdvKitCharacter> ForCharacterClass, AAdvKitZoneRectangle* SourceWall, AAdvKitZoneRectangle* TargetCeiling)
{
	...
	//Create transition
	auto Transition = CreateTransitionLine(this, "ToCeiling", SourceWall, TransitionSourceBottom, TransitionTargetBottom, TransitionSourceTop, TransitionTargetTop, ForCharacterClass, TargetCeiling->GetPhysics(), TargetCeiling);
	if (!Transition)
	{
		return false;
	}
...
bool UAdvKitBuildModule_Wall_Ceiling::CreateTransitionFromCeilingToWall(TSubclassOf<AAdvKitCharacter> ForCharacterClass, AAdvKitZoneRectangle* SourceCeiling, AAdvKitZoneRectangle* TargetWall)
{
	...
	//Create transition
	auto Transition = CreateTransitionLine(this, "ToWall", SourceCeiling, TransitionSourceBottom, TransitionTargetBottom, TransitionSourceTop, TransitionTargetTop, ForCharacterClass, TargetWall->GetPhysics(), TargetWall);
	if (!Transition)
	{
		return false;
	}
