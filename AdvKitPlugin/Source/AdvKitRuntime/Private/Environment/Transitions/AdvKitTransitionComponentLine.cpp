...
void UAdvKitTransitionComponentLine::DrawDebug_Implementation(const FColor& DebugColor, const float& DebugThickness, const float& DebugLifeTime)
{
	DrawDebugDirectionalArrow(GetWorld(), GetMinSourceLocation(), GetMinTargetLocation(), DebugThickness*2, DebugColor, false, DebugLifeTime, 0, DebugThickness);
	DrawDebugDirectionalArrow(GetWorld(), GetMaxSourceLocation(), GetMaxTargetLocation(), DebugThickness*2, DebugColor, false, DebugLifeTime, 0, DebugThickness);
}
