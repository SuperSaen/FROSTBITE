...
protected:
	...
	UPROPERTY(BlueprintReadOnly, Category = "Weapon", ReplicatedUsing = OnRep_BurstCounter)
	int32 BurstCounter;
...
protected:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Weapon", meta = (DisplayName = "Get Fire Mode Default Object", BlueprintProtected))
	UAdvKitFireModeConfiguration* GetFireModeBP(uint8 FireModeIndex); //TODO const for blueprint call, maybe TAssetPtr?
...
public:
	//Begin AdvKitInventoryItem Interface
	virtual void Uneqiup(bool bInstant = false) override;
	//End AdvKitInventoryItem Interface
};
