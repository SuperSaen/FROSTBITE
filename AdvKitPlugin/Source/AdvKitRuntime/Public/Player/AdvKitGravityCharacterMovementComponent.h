...
public:
	...
	void SetFromSweepHACK(FFindFloorResult& Out, const FHitResult& InHit, const float InSweepFloorDist, const bool bIsWalkableFloor) const; //TODO FFindFloorResult does not export this function...
	void SetFromLineTraceHACK(FFindFloorResult& Out, const FHitResult& InHit, const float InSweepFloorDist, const float InLineDist, const bool bIsWalkableFloor) const; //TODO FFindFloorResult does not export this function...
	virtual bool IsWithinEdgeTolerance(const FVector& CapsuleLocation, const FVector& TestImpactPoint, const float CapsuleRadius) const override;//TODO override; Base method is not virtual WHY?!
