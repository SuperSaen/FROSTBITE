...
#include "AdvKitTransitionComponentLine.generated.h"

/**
 * @brief Transition that is an area between two defined lines on the source and target zone. 
 */
UCLASS()
class ADVKITRUNTIME_API UAdvKitTransitionComponentLine : public UAdvKitTransitionComponent
{
	GENERATED_BODY()

	friend class FAdvKitTransitionComponentLineVisualizer;
...
public:
	...
	virtual void DrawDebug_Implementation(const FColor& DebugColor, const float& DebugThickness, const float& DebugLifeTime) override;
